...
public class OtherLendMoneyService {
    ...
    public void addOtherLendMoney(AddOtherLendMoneyParam param) {
        ...
        int insertCount = otherLendMoneyDao.insertOtherLendMoney(param.getCarLicenseNum(), param.getLendDate(), param.getAmount(), param.getDisable(), param.getNote(), l, l);
    ...
    public void updateOtherLendMoney(UpdateOtherLendMoneyParam param) {
        long l = LocalDateTime.now().toEpochSecond(ZoneOffset.UTC);
        int updateCount = otherLendMoneyDao.updateOtherLendMoney(param.getCarLicenseNum(), param.getLendDate(), param.getAmount(), param.getDisable(), param.getNote(), l, param.getId());
