...
public class OtherGiveBackMoneyService {
    ...
    public void voidAndRebillToMonth(VoidAndRebillToMonthParam param) {
        ...
        String srcBillYearMonth = DateTimeUtil.toBillYearMonth(src.getGiveBackDate());
        ...
        if (param.getTargetBillYearMonth().equals(srcBillYearMonth)) {
            ...
            otherGiveBackMoneyDao.save(src);
            refreshMonthBillSnapshotsForGiveBackMonths("其他抵收報廢", src.getCarLicenseNum(), srcBillYearMonth);
            return;
        }
